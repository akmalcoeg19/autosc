...
[Unit]
Description=Ssh Websocket By Zanxx
Documentation=https://t.me/spacedataxxx
...
wget -q -O /usr/local/bin/edu-ovpn https://raw.githubusercontent.com/akmalcoeg19/autosc/main/edu-op.py
...
[Unit]
Description=Ovpn Websocket By Zanxx
Documentation=https://t.me/spacedataxxx
After=network.target nss-lookup.target
